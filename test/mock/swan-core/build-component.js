...
const componentDefaultProps = {swaninterface: swaninterface()};
...
export default function buildComponent(name, componentProto, ...args) {
        ...
        const componentFactory = getComponentFactory({swaninterface: swaninterface()}, getComponentsProtos, getBehaviorDecorators());      
        componentProto=componentFactory.mergeComponentProtos(componentProto,swaninterface());
 ...
 */
export function getComponentClass(name, componentProto) {
     const componentFactory = getComponentFactory({swaninterface: swaninterface()}, getComponentsProtos, getBehaviorDecorators());      
     componentProto = componentFactory.mergeComponentProtos(componentProto,swaninterface());
     componentFactory.componentDefine(name, componentProto);
...
export function getFactory() {
     return getComponentFactory({swaninterface: swaninterface()}, getComponentsProtos, getBehaviorDecorators());      
}
